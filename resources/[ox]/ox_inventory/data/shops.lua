return {
	General = {
		...
		blip = {
			...
			{ loc = vec3(25.06, -1347.32, 29.5), length = 1.5, width = 3.0, heading = 0.0, minZ = 29.5, maxZ = 29.9, distance = 2 },
	...
	SKBM = {
		name = 'Blackmarket',
		inventory = {
			{ name = 'weapon_pistol', price = 10, currency = "black_money" },
			{ name = 'weapon_assaultrifle', price = 10,  currency = "black_money" },
			{ name = 'weapon_carbinerifle', price = 10,  currency = "black_money" },
		},
		locations = {
			vec3(-344.4561, -137.5738, 39.0103),
		},
	},
	...
	weed_supplies = {
		...
		locations = {
			vec3(-1171.082, -1571.244, 4.664)
		}, 
		targets = {
			{ loc = vec3(-1171.082, -1571.244, 4.664), length = 0.5, width = 1.0, heading = 123.58, minZ = 4.5, maxZ = 6.0, distance = 6 }
		},
	}
}
